    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 'MainActivity'로 이동
                Intent intent = new Intent(guideFruitActivity.this, MainActivity.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 'fruitActivity'로 이동
                Intent intent = new Intent(guideFruitActivity.this, fruitActivity.class);
                startActivity(intent);
            }
        });
    }
    class Task extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void...voids) {
            try{
                ...
                ResultSet resultSet_day3 = statement.executeQuery("SELECT day3 FROM fruit WHERE item_code = '" + fruitActivity.keyItemCode + "' AND kind_code = '" + fruitActivity.keyKindCode + "' AND ranks = '" + fruitActivity.keyRanks + "'");
                while(resultSet_day3.next()){
                    reday3 += resultSet_day3.getString(1);
                }

                ResultSet resultSet_day7 = statement.executeQuery("SELECT day7 FROM fruit WHERE item_code = '" + fruitActivity.keyItemCode + "' AND kind_code = '" + fruitActivity.keyKindCode + "' AND ranks = '" + fruitActivity.keyRanks + "'");
                while(resultSet_day7.next()){
                    reday7 += resultSet_day7.getString(1);
                }

                ResultSet resultSet_dpr2 = statement.executeQuery("SELECT dpr2 FROM fruit WHERE item_code = '" + fruitActivity.keyItemCode + "' AND kind_code = '" + fruitActivity.keyKindCode + "' AND ranks = '" + fruitActivity.keyRanks + "'");
                while(resultSet_dpr2.next()){
                    redpr2 += resultSet_dpr2.getString(1) ;
                }

                ResultSet resultSet_dpr3 = statement.executeQuery("SELECT dpr3 FROM fruit WHERE item_code = '" + fruitActivity.keyItemCode + "' AND kind_code = '" + fruitActivity.keyKindCode + "' AND ranks = '" + fruitActivity.keyRanks + "'");
                while(resultSet_dpr3.next()){
                    redpr3 += resultSet_dpr3.getString(1);
                }

                ResultSet resultSet_dpr7 = statement.executeQuery("SELECT dpr7 FROM fruit WHERE item_code = '" + fruitActivity.keyItemCode + "' AND kind_code = '" + fruitActivity.keyKindCode + "' AND ranks = '" + fruitActivity.keyRanks + "'");
                while(resultSet_dpr7.next()){
                    redpr7 += resultSet_dpr7.getString(1);
                }

                ResultSet resultSet_itemName = statement.executeQuery("SELECT item_name, kind_name FROM fruit WHERE item_code = '" + fruitActivity.keyItemCode + "' AND kind_code = '" + fruitActivity.keyKindCode + "' AND ranks = '" + fruitActivity.keyRanks + "'");
                while(resultSet_itemName.next()){
                    reitemName += resultSet_itemName.getString(1) + " " + resultSet_itemName.getString(2);
                }

                ResultSet resultSet_unit = statement.executeQuery("SELECT unit FROM fruit WHERE item_code = '" + fruitActivity.keyItemCode + "' AND kind_code = '" + fruitActivity.keyKindCode + "' AND ranks = '" + fruitActivity.keyRanks + "'");
                while(resultSet_unit.next()){
                    reunit += resultSet_unit.getString(1);
                }

                ResultSet resultSet_ranks = statement.executeQuery("SELECT ranks FROM fruit WHERE item_code = '" + fruitActivity.keyItemCode + "' AND kind_code = '" + fruitActivity.keyKindCode + "' AND ranks = '" + fruitActivity.keyRanks + "'");
